...
class HBNBCommand(cmd.Cmd):
    ...
    def help_all(self):
        """ To help information for the all command"""
    ...
    def do_update(self, args):
        ...
        # to isolate cls from id/args, ex: (<cls>, delim, <id/args>)
        args = args.partition(" ")
        if args[0]:
            c_name = args[0]
        ...
        # to generate key from class and id
        key = f"{c_name}.{c_id}"

        # to determine if key is present
        ...
        for i, att_name in enumerate(args):
            ...
            if i % 2 == 0:
                ...
                # to update the dictionary with name, the value pair
                new_dict.__dict__.update({att_name: att_val})

        new_dict.save()  # saves update to file
        storage.save()
